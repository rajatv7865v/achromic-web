          ...
          {featuredEvents.map((event) => (
            ...
            >
              <div className='relative'>
                <div className='h-64 bg-gradient-to-br from-[#be3437]/10 to-[#6c7cae]/10 flex items-center justify-center'>
                  <div className='text-center'>
              ...
              >
                <div className='relative'>
                  <div className='h-48 bg-gradient-to-br from-[#be3437]/5 to-[#6c7cae]/5 flex items-center justify-center'>
                    <div className='text-center'>
                      <CalendarIcon className='w-12 h-12 text-[#be3437] mx-auto mb-2' />
                  ...
                  {hoveredEvent === event.id && (
                    <div className='absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center space-x-3'>
                      ...
                      <button className='bg-white text-gray-700 px-4 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-200'>
                        Gallery
                      </button>
                    </div>
                  )}
                ...
                <div className='p-4'>
                  <div className='flex items-center justify-between mb-2'>
                    <span className='bg-[#be3437]/10 text-[#be3437] px-2 py-1 rounded text-xs font-medium'>
                      {event.category}
                    </span>
                    <div className='flex items-center space-x-1'>
                      {renderStars(event.rating)}

            ...
            {isLoggedIn ? (
              <div className="relative">
                <button className="flex items-center gap-2 p-2 text-gray-700 hover:text-[#2b8ffb] transition-colors duration-200">
                  ...
                  <span className="hidden md:block text-sm font-medium">{user?.firstName || user?.email?.split('@')[0] || 'User'}</span>
                </button>
              ...
              {isLoggedIn ? (
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-[#2b8ffb] to-[#6c7cae] text-white px-6 py-3 rounded-lg font-semibold hover:from-[#2b8ffb]/90 hover:to-[#6c7cae]/90 transition-all duration-200"
                  >
                    Sign Out
                  </button>
                </div>

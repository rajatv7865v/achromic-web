          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-center">
                ...
                <a href="tel:011-4601-1835" className="hover:text-white transition-colors">
                  011-4601-1835
                </a>
              </li>
              <li className="flex items-center">
                <span className="mr-2">📧</span>
                <a href="mailto:contactus@achromicpoint.com" className="hover:text-white transition-colors">
                  contactus@achromicpoint.com
                </a>
              </li>
              <li className="flex items-start">
                <span className="mr-2 mt-1">📍</span>
                <span>F-11, First Floor, Kalkaji, New Delhi-110019, India</span>
              </li>
            </ul>
          </div>
        </div>
